...
let keyListen = document.getElementById("message")

keyListen.addEventListener("keyup", function (event) {
    firstOutput.innerHTML = event.target.value
    secondOutput.innerHTML = event.target.value
})